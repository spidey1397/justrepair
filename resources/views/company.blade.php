...
@section('carousel')
    @include('includes.carousel-company')
@endsection
    ...
    <div class="row"> 
      ...
      <div class="col-12 text-center">       
        ...
        <div class="row"> 
            ...
            <a href="{{url('services')}}/{{$product}}-repairing-service-center/{{$company->name}}-service-center-{{$area}}"><strong class="pr-1">{{ucwords(str_replace('-', ' ', $company->name))}} Service Center In {{ucwords(str_replace('-', ' ', $area))}}</strong></a>
