  ...
  <header>
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
              ...
              <h2 class="display-7">{{ucwords(str_replace('-', ' ', $product))}} Experts</h2>
                  <strong class="lead">Best {{ucwords(str_replace('-', ' ', $product))}} Repairing Service In @if (isset($city)) {{ucfirst($city)}} @else {{ucwords(str_replace('-', ' ', $area))}} @endif.</strong> <br>
              ...
              <div class="carousel-item banner-onsite1">
                <div class="carousel-caption d-block d-md-block text-white" style="vertical-align: top; position: static;">
                  <h2 class="display-7">Best Reasonable rate in @if (isset($city)) {{ucfirst($city)}} @else {{ucwords(str_replace('-', ' ', $area))}} @endif</h2>
